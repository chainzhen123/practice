...
public class selfCenter_cloud_jhskf {
  ...
  public void cloud_jhskf() throws InterruptedException {
    ...
    Thread.sleep(3000);
    driver.findElement(By.cssSelector(".el-dropdown-menu__item:nth-child(6)")).click();   //点击 远程连接
    Thread.sleep(3000);
	    
	//   
    driver.findElement(By.cssSelector(".el-form-item:nth-child(1) .el-input__inner")).click();
    driver.findElement(By.cssSelector(".el-form-item:nth-child(1) .el-input__inner")).sendKeys("1");
    ...
    driver.findElement(By.cssSelector(".el-form-item__content:nth-child(1) > .el-button--success")).click();
