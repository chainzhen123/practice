...
public class selfCenter_cloud_mxbs {
  ...
  public void cloud_mxbs() throws InterruptedException {
    ...
    Thread.sleep(3000);
    driver.findElement(By.cssSelector(".el-dropdown-menu__item:nth-child(6)")).click();   //点击 模型部署
    Thread.sleep(3000);
    ...
    driver.findElement(By.cssSelector(".el-form-item:nth-child(3) .el-input__inner")).sendKeys("/usr/local");
    driver.findElement(By.cssSelector(".radiodiv:nth-child(1) .el-radio__label")).click();
    driver.findElement(By.cssSelector(".is-bordered:nth-child(1)")).click();
    driver.findElement(By.cssSelector(".is-focus > .el-input__inner")).click();
