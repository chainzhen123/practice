 ...
 *
 */
public class calCenter_yclj_vnc {
  ...
  public void yclj() throws InterruptedException {
    ...
    Thread.sleep(2000);
    driver.findElement(By.xpath("//span[text()='vnc']")).click();
    Thread.sleep(2000);
       
    //镜像名称
    driver.findElement(By.cssSelector(".el-form-item:nth-child(3) .el-input__inner")).click();
    Thread.sleep(2000);
    driver.findElement(By.xpath("//span[text()='192.168.1.117/ssh/java:base']")).click();
    Thread.sleep(2000);
...
//    Assert.assertTrue(res2);
    ...
    //删除远程连接断言
    boolean res3 = driver.findElement(By.tagName("body")).getText().contains("remote06");
