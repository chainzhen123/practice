 ...
 *
 */
public class BigData_6_CreateKylin {
  ...
  @Test
  public void create_Kylin() throws InterruptedException {
    ...
    Thread.sleep(2000);
    //选择kylin
    driver.findElement(By.xpath("//span[text()='Kylin']")).click();
    Thread.sleep(2000);
    //确定
    ...
    Thread.sleep(2000);
    driver.findElement(By.cssSelector("div:nth-child(1) > .el-form-item:nth-child(2) .el-input__inner")).sendKeys("2");
    Thread.sleep(2000);
    ...
    //kylin详情页面
    driver.findElement(By.xpath("//div[contains(text(),'kylin')]")).click();
    Thread.sleep(3000);
    //断言
    boolean res2 = driver.findElement(By.tagName("body")).getText().contains("Kylin-Master");
    boolean res3 = driver.findElement(By.tagName("body")).getText().contains("Kylin-Node");
    ...
    Thread.sleep(3000);
    //断言
    boolean res4 = driver.findElement(By.tagName("body")).getText().contains("7070");
