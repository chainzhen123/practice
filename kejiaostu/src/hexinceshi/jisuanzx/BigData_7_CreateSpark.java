 ...
 *
 */
public class BigData_7_CreateSpark{
  ...
  public void untitled() throws InterruptedException {
    ...
    Thread.sleep(2000);
    //选择spark
    driver.findElement(By.xpath("//span[text()='Spark']")).click();
    Thread.sleep(2000);
    //确定
    ...
    Thread.sleep(2000);
    //进入详情页面
    driver.findElement(By.xpath("//div[contains(text(),'spark')]")).click();
    Thread.sleep(2000);
    //断言
    boolean res2 = driver.findElement(By.tagName("body")).getText().contains("Spark-Master");
    boolean res3 = driver.findElement(By.tagName("body")).getText().contains("Spark-Slave");
    ...
    Thread.sleep(2000);
    //断言
    boolean res4 = driver.findElement(By.tagName("body")).getText().contains("8080");
