...
import java.net.URL;
 ...
 /**
  * 科教平台-授课教师-课程管理页面内容检查。
  * 注意：需要是该课程的授课教师账户才可以。普通教师对于此课程没有管理功能
  * @author chain
  *
  */
public class teachCenter2_teach_course_manage {
  ...
  public void Test1234() throws InterruptedException {
    ...
    //授课中状态检查（授课教师单独有的状态）
    boolean res5 = driver.findElement(By.tagName("body")).getText().contains("授课中");
    ...
    boolean res3 = driver.findElement(By.tagName("body")).getText().contains("课程标题");
